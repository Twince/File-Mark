...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(os.path.join(path, "Icons/Search.png")), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)  # 수정
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(os.path.join(path, "Icons/Foward.png")), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)  # 수정
