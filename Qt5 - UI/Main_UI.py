...
from PyQt5.QtWidgets import * # qt위젯
...
#-------------------------------------------------------------------------------------------------------------------------------------
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(os.path.join(path,"Icons/Search.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off) #수정
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(os.path.join(path,"Icons/Back.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off) #수정
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(os.path.join(path,"Icons/Foward.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off) #수정
        ...
        #좌측 트리뷰 기능 구현
        Dirpath = QDir.rootPath() #Dirpath는 path변수를 이미 썼기에 Dir붙임거임

        self.dirModel = QFileSystemModel()
        self.dirModel.setRootPath(QDir.rootPath())
        self.dirModel.setFilter(QDir.NoDotAndDotDot | QDir.AllDirs)

        self.tree_view.setModel(self.dirModel)
        self.tree_view.setRootIndex(self.dirModel.index(path))

        #우측 트리뷰 리스트뷰 기능 구현
        self.fileModel = QFileSystemModel()
        self.fileModel.setFilter(QDir.NoDotAndDotDot |  QDir.Files)

        self.list_view.setModel(self.fileModel)
        self.list_view.setRootIndex(self.fileModel.index(path))
    ...
    def on_clicked(self, index):
        ...
        self.list_view.setRootIndex(self.fileModel.setRootPath(path))
